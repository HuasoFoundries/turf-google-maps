(function (QUnit) {
    ...
    QUnit.test('turfHelper.polylineToFeatureLinestring converts a google.maps.Polyline into a Feature with Polyline geometry', function (assert) {
        ...
        var runtest = function (gmaps) {
            ...
            assert.deepEqual(result, featurePolyline, 'turfHelper.polylineToFeatureLinestring converts a google.maps.Polyline into a Feature with Linestring geometry'); // eslint-disable-line max-len
            done();
        };
