(function (QUnit) {
    ...
    QUnit.module("turfUtils pointInPolygon");


    QUnit.test('pointInPolygon should be of type function', function (assert) {
        assert.equal(typeof turfUtils.pointInPolygon, 'function', 'pointInPolygon should be of type function');
    });
    ...
    QUnit.test('pointInPolygon detects which points are inside and outside a given Feature.Polygon', function (assert) {
        ...
        var runtest = function (gmaps) {
            ...
            var result = turfUtils.pointInPolygon([gmMarkerIn, gmMarkerOut], testAssets.squareFeature1);
