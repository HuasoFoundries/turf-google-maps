(function (QUnit) {
    ...
    QUnit.test('turfHelper.polygonToFeaturePolygon converts a google.maps.Polygon into a Feature with Polygon geometry', function (assert) {
        ...
        var runtest = function (gmaps) {
            ...
            assert.deepEqual(result, featurePolygon, 'turfHelper.polygonToFeaturePolygon converts a google.maps.Polygon into a Feature with Polygon geometry'); // eslint-disable-line max-len
            done();
        };
