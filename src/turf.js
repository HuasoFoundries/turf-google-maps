...
function coordEach(geojson, callback, excludeWrapCoord) {
    ...
    var featureIndex, geometryIndex, j, k, l, geometry$$1, stopG, coords,
...
extend$1(GeoJSONParser.prototype, {
  /**
...
extend$1(GeoJSONReader.prototype, {
  /**
...
extend$1(GeoJSONWriter.prototype, {
  /**
...
extend$1(GeometryCollectionMapper.prototype, {
	map: function (gc) {
...
extend$1(GeometryTransformer.prototype, {
...
extend$1(LineStringSnapper.prototype, {
...
extend$1(GeometrySnapper.prototype, {
...
extend$1(SnapTransformer.prototype, {
...
extend$1(CommonBitsRemover.prototype, {
...
extend$1(CommonCoordinateFilter.prototype, {
	filter: function (coord) {
...
extend$1(SegmentString.prototype, {
	getCoordinates: function () {},
	size: function () {},
	getCoordinate: function (i) {},
	isClosed: function () {},
...
extend$1(BasicSegmentString.prototype, {
	getCoordinates: function () {
		return this.pts;
	},
	size: function () {
...
extend$1(SegmentPointComparator.prototype, {
	interfaces_: function () {
		return [];
	},
	getClass: function () {
...
extend$1(SegmentNode.prototype, {
	getCoordinate: function () {
		return this.coord;
	},
	print: function (out) {
...
extend$1(SegmentNodeList.prototype, {
...
extend$1(NodeVertexIterator.prototype, {
	next: function () {
...
extend$1(NodableSegmentString.prototype, {
...
extend$1(NodedSegmentString.prototype, {
	getCoordinates: function () {
		return this.pts;
	},
	size: function () {
...
extend$1(MonotoneChainOverlapAction.prototype, {
	overlap: function () {
		if (arguments.length === 2) {
...
extend$1(SinglePassNoder.prototype, {
...
extend$1(MCIndexNoder.prototype, {
...
extend$1(SegmentOverlapAction.prototype, {
	overlap: function () {
		if (arguments.length === 4) {
			let mc1 = arguments[0], start1 = arguments[1], mc2 = arguments[2], start2 = arguments[3];
...
extend$1(SegmentIntersector$1.prototype, {
...
extend$1(InteriorIntersectionFinder.prototype, {
...
extend$1(FastNodingValidator.prototype, {
	execute: function () {
...
extend$1(EdgeNodingValidator.prototype, {
	checkValid: function () {
		this.nv.checkValid();
	},
	interfaces_: function () {
...
extend$1(PolygonBuilder.prototype, {
...
extend$1(LineBuilder.prototype, {
...
function PointBuilder() {
	...
	let op = arguments[0], geometryFactory = arguments[1];
	this.op = op;
	this.geometryFactory = geometryFactory;
}
extend$1(PointBuilder.prototype, {
...
extend$1(OrientedCoordinateArray.prototype, {
...
extend$1(SnapOverlayOp.prototype, {
...
extend$1(SnapIfNeededOverlayOp.prototype, {
	getResultGeometry: function (opCode) {
		var result = null;
		var isSuccess = false;
...
extend$1(InteriorPointArea.prototype, {
...
extend$1(SafeBisectorFinder.prototype, {
...
extend$1(GeometryCombiner.prototype, {
...
extend$1(PointGeometryUnion.prototype, {
	union: function () {
...
extend$1(GeometryExtracter.prototype, {
	filter: function (geom) {
...
extend$1(CascadedPolygonUnion.prototype, {
...
extend$1(UnaryUnionOp.prototype, {
...
extend$1(InteriorPointLine.prototype, {
	addEndpoints: function () {
		if (arguments[0] instanceof Geometry) {
			let geom = arguments[0];
			if (geom instanceof LineString) {
...
extend$1(BufferParameters.prototype, {
...
extend$1(RightmostEdgeFinder.prototype, {
	getCoordinate: function () {
...
extend$1(BufferSubgraph.prototype, {
...
extend$1(BufferInputLineSimplifier.prototype, {
...
extend$1(OffsetSegmentString.prototype, {
	getCoordinates: function () {
...
extend$1(OffsetSegmentGenerator.prototype, {
...
extend$1(OffsetCurveBuilder.prototype, {
...
extend$1(SubgraphDepthLocater.prototype, {
...
extend$1(DepthSegment.prototype, {
	compareTo: function (obj) {
		var other = obj;
...
extend$1(OffsetCurveSetBuilder.prototype, {
	addPoint: function (p) {
...
extend$1(IntersectionAdder.prototype, {
	isTrivialIntersection: function (e0, segIndex0, e1, segIndex1) {
		if (e0 === e1) {
			if (this.li.getIntersectionNum() === 1) {
...
extend$1(BufferBuilder.prototype, {
...
extend$1(ScaledNoder.prototype, {
	rescale: function () {
		if (hasInterface(arguments[0], Collection)) {
			let segStrings = arguments[0];
			for (var i = segStrings.iterator(); i.hasNext(); ) {
...
extend$1(NodingValidator.prototype, {
...
extend$1(MCIndexPointSnapper.prototype, {
	snap: function () {
		if (arguments.length === 1) {
...
extend$1(HotPixelSnapAction.prototype, {
...
extend$1(InteriorIntersectionFinderAdder.prototype, {
	processIntersections: function (e0, segIndex0, e1, segIndex1) {
		if (e0 === e1 && segIndex0 === segIndex1) return null;
		var p00 = e0.getCoordinates()[segIndex0];
		var p01 = e0.getCoordinates()[segIndex0 + 1];
...
extend$1(MCIndexSnapRounder.prototype, {
...
extend$1(UniqueCoordinateArrayFilter.prototype, {
	filter: function (coord) {
...
extend$1(RadialComparator.prototype, {
	compare: function (o1, o2) {
		var p1 = o1;
		var p2 = o2;
...
extend$1(InteriorPointPoint.prototype, {
	getInteriorPoint: function () {
		return this.interiorPoint;
	},
	add: function () {
        ...
        if (featuresWithoutParent.length > 1) {
            for (var i = 0; i < featuresWithoutParent.length; i++) {
                ...
                for (var j = 0; j < output.features.length; j++) {
                    ...
                    if (inside(point(output.features[featuresWithoutParent[i]].geometry.coordinates[0][0]), output.features[j], { ignoreBoundary: true })) {
...
var topojsonServer = createCommonjsModule(function (module, exports) {
...
var topojsonClient = createCommonjsModule(function (module, exports) {
 ...
 * });
 */
function coordEach$2(layer, callback, excludeWrapCoord) {
...
function coordReduce$1(layer, callback, initialValue, excludeWrapCoord) {
    var previousValue = initialValue;
    coordEach$2(layer, function (currentCoords, currentIndex) {
...
var coordReduce_1 = coordReduce$1;
...
var featureEach_1 = featureEach$2;
...
var featureReduce_1 = featureReduce$1;
...
function coordAll$1(layer) {
    var coords = [];
    coordEach$2(layer, function (coord) {
        coords.push(coord);
    });
    return coords;
}
var coordAll_1 = coordAll$1;
...
var geojsonFlatten = flatten;

var createTopology = topojsonServer.topology;
var mergeTopology = topojsonClient.merge;

var geomEach$1 = meta$4.geomEach;
...
function dissolve () {
  ...
  switch (type) {
    case 'LineString':
      return geojsonLinestringDissolve(geoms)
    case 'Polygon':
...
function concave(points, options) {
    ...
    var dissolved = geojsonDissolve(tinPolys.features);
...
function convertToMercator(lonLat) {
    ...
    var adjusted = (Math.abs(lonLat[0]) <= 180) ? lonLat[0] : (lonLat[0] - (sign$1(lonLat[0]) * 360));
    var xy = [
        A * adjusted * D2R,
...
function bearing(start, end, options) {
    ...
    var lon1 = degrees2radians$$1 * coordinates1[0];
    var lon2 = degrees2radians$$1 * coordinates2[0];
    var lat1 = degrees2radians$$1 * coordinates1[1];
    var lat2 = degrees2radians$$1 * coordinates2[1];
    ...
    var bear = radians2degrees$$1 * Math.atan2(a, b);
...
export { kinks, inside, simplify, lineIntersect, union, unkinkPolygon, concave, buffer, along, lineSlice, point, lineString, featureCollection };
